...
<li>System handles 200+ concurrent users without performance issues</li>
  ...
  const translationData = [
    ...
    { key: "home.hero.subtitle", en: "Software Developer", pl: "Software Developer" },
    ...
    // About page - bio
    { key: "about.bio_1", en: "I am Adam Szczotka, a Software Developer. I have been coding since the age of 11. I build scalable backends, fast mobile applications, and privacy-first web tools.", pl: "Jestem Adam Szczotka, Software Engineer i Architekt Produktów. Koduję od 11. roku życia. Buduję skalowalne backendy, szybkie aplikacje mobilne i narzędzia webowe z naciskiem na prywatność." },
    ...
    await db.insert(pageBlocks).values([
      {
        ...
        dataEn: {
          title: "About",
          description:
            "Software Developer. Coding since age 11.",
        },
        dataPl: {
          title: "O mnie",
          description:
            "Software Developer. Koduję od 11. roku życia.",
        },
      },
      {
        pageId: aboutPage.id,
        ...
        position: 1,
        dataEn: {
          html: "<p>I am Adam Szczotka, a Software Developer. I have been coding since the age of 11. I build scalable backends, fast mobile applications, and privacy-first web tools.</p><p>My approach is shaped by discipline built through years of competitive sports and a personal transformation that included losing 70 kg. That same discipline drives how I build software: methodically, with attention to detail, and always delivering business value.</p>",
        },
        dataPl: {
